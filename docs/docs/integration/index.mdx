...
Agent Skills integrates seamlessly with Pydantic AI agents via `DatalayerSkillsToolset`.

## Overview

The `DatalayerSkillsToolset` exposes skills as tools that AI agents can use:
